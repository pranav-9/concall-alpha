...
export function UnofficialChip({ scoredAt }: { scoredAt?: string | null }) {
  return (
    <span
...
export function FreshScoreChip({ scoredAt }: { scoredAt?: string | null }) {
  return (
    <span
      className={`${CHIP_BASE} border-foreground/30 bg-foreground/[0.07] text-foreground`}
      title={
