        ...
        {years.map((year) => {
          ...
          return (
            <div key={year} className="space-y-2">
              <div className="flex items-center gap-2">
                <Badge className="text-[11px] px-2 py-0.5 bg-gray-800 text-gray-200">
                  Fiscal Year: {year}
                </Badge>
                <span className="text-xs text-gray-400">
                  Showing top {strategiesForYear.length} strategies
                </span>
              </div>
                      ...
                      {(strategy.description ||
                        ...
                        <div className="mt-auto space-y-2">
                          {(strategy.description ||
                            (strategy.impact_value !== null &&
                              strategy.impact_value !== undefined)) && (
                            <details className="rounded-lg border border-gray-700/60 bg-gray-900/40 p-3">
