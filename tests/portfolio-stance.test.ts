...
expectStance(
  ...
  { latestConcallScore: 8.5, trendChange: 0.4, growthScore: 8.2, trajectoryKey: "strong_steady", moatTier: "mid" },
  "compounding",
);
// Sansera — 8.2, Climbing (+1.2), Forward 7.9, Narrow/Mid moat.
expectStance(
  "SANSERA climbing + solid outlook + moat",
  { latestConcallScore: 8.2, trendChange: 1.2, growthScore: 7.9, trajectoryKey: "climbing", moatTier: "mid" },
  "compounding",
);
...
expectStance(
  ...
  { latestConcallScore: 7.8, trendChange: -0.2, growthScore: 8.5, trajectoryKey: "strong_steady", moatTier: "mid" },
  "compounding",
);
...
expectStance(
  ...
  { latestConcallScore: 7.8, trendChange: -0.1, growthScore: 8.1, trajectoryKey: "strong_steady", moatTier: null },
  "thin_underwrite",
);
...
expectStance(
  ...
  { latestConcallScore: 7.5, trendChange: 0.9, growthScore: 7.8, trajectoryKey: "climbing", moatTier: null },
  "improving",
);
expectStance(
  "improving: recovering off a low",
  { latestConcallScore: 6.4, trendChange: 0.7, growthScore: 7.6, trajectoryKey: "recovering", moatTier: "mid" },
  "improving",
);
...
expectStance(
  ...
  { latestConcallScore: 6.8, trendChange: -0.9, growthScore: 8.4, trajectoryKey: "cracking", moatTier: "strong" },
  "outlook_led",
);
...
expectStance(
  ...
  { latestConcallScore: 7.0, trendChange: -0.7, growthScore: 8.0, trajectoryKey: "steady", moatTier: "mid" },
  "outlook_led",
);
...
expectStance(
  ...
  { latestConcallScore: 6.0, trendChange: -1.0, growthScore: 6.8, trajectoryKey: "worsening", moatTier: "mid" },
  "cracking",
);
// Strong outlook can't earn outlook-led without a moat read.
expectStance(
  "cracking: strong outlook but no moat",
  { latestConcallScore: 7.0, trendChange: -0.8, growthScore: 8.2, trajectoryKey: "cracking", moatTier: null },
  "cracking",
);
...
expectStance(
  ...
  { latestConcallScore: 8.3, trendChange: 0.1, growthScore: 7.2, trajectoryKey: "steady", moatTier: "mid" },
  "near_peak",
);
expectStance(
  "near_peak: strong-steady top, cool outlook",
  { latestConcallScore: 8.1, trendChange: 0.2, growthScore: 7.0, trajectoryKey: "strong_steady", moatTier: "mid" },
  "near_peak",
);
...
expectStance(
  ...
  { latestConcallScore: 7.2, trendChange: 0.0, growthScore: 7.3, trajectoryKey: "steady", moatTier: "mid" },
  "steady",
);
...
expectStance(
  ...
  { latestConcallScore: 5.5, trendChange: 0.0, growthScore: 6.0, trajectoryKey: "weak_stuck", moatTier: null },
  "soft_stuck",
);
expectStance(
  "soft_stuck: low, no forward read",
  { latestConcallScore: 6.0, trendChange: 0.0, growthScore: null, trajectoryKey: "steady", moatTier: null },
  "soft_stuck",
);

// No read — no anchor score, or fewer than 3 scored quarters.
expectStance("no_read: null score", { latestConcallScore: null, trajectoryKey: "strong_steady" }, "no_read");
expectStance(
  "no_read: <3 quarters",
  { latestConcallScore: 7.0, growthScore: 8.0, trajectoryKey: "no_read", moatTier: "mid" },
  "no_read",
);
